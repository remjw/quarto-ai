...
# The Tortoise and the Hare {#turtlehare}

The problem description is from [@deitel_intro_2019] (Simulation: The Tortoise and the Hare). The flowchart and the code are original.
...
The game is a terminal/console-based program/application. The following are two sample runs.
